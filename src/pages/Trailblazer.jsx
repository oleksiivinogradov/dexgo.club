...
import sneakerImage from '../assets/scraped/Type2_2.png';
            ...
            <div className="container">
                ...
                <div className="grid md-grid-cols-2 gap-8 items-center">
                    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', background: '#111', borderRadius: '20px', padding: '40px' }}>
                        <img src={sneakerImage} alt="Trailblazer" style={{ width: '100%', maxWidth: '400px' }} />
                    </div>

                    <div>
                        <h6 style={{ color: '#888', marginBottom: '10px' }}>Home / <Link to="/marketplace" style={{ color: 'var(--primary-color)' }}>Marketplace</Link></h6>
                        <h1 className="gradient-text" style={{ fontSize: '3rem', marginBottom: '20px' }}>Trailblazer</h1>
                        <h2 style={{ color: 'var(--primary-color)', fontSize: '2rem', marginBottom: '30px' }}>USD 29.90</h2>

                        <p style={{ fontSize: '1.1rem', lineHeight: '1.8', marginBottom: '40px' }}>
                            Ideal for those who like to walk at a moderate pace and enjoy the scenery.
                            These sneakers will help you discover 20 kilometers of interesting routes without fatigue.
                        </p>

                        <a
                            href="https://pay.fondy.eu/s/OVx6"
                            target="_blank"
